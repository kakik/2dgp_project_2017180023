...
class Cursor:
    ...
    def draw(self):
        if self.cursor_clicked_animation != 0:
            self.image.clip_draw(46, 232, 41, 41, self.x - game_world.screen_coord_x, self.y - game_world.screen_coord_y, self.width * self.cursor_clicked_animation_size, self.height * self.cursor_clicked_animation_size)
